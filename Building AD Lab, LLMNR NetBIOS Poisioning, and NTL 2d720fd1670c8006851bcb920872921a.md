...
1. Although Kali Linux already comes with impacket we install a new version of impacket for kali
    ...
    - apt purge **impacket**
    - go to: [https://github.com/fortra/impacket](https://github.com/fortra/impacket)
    - move to opt folder
        - cd /opt/
2. git clone [https://github.com/fortra/impacket](https://github.com/fortra/impacket) - clones file from github
...
[image](https://github.com/user-attachments/assets/0fd58b17-c68e-4aec-b86e-a8f816a50b0c)
...
[image](https://github.com/user-attachments/assets/3f094019-01fe-4e51-9800-06866900eecc)
...
[image](https://github.com/user-attachments/assets/25f2a666-c60c-4c93-851e-41eff4a18bd3)
...
[image](https://github.com/user-attachments/assets/459270bd-7af2-473e-b5a7-0400333a4329)

- Open your files and go to the local C: drive on your computer and create a folder called hackme

![Screenshot 2025-12-16 102257.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/Screenshot_2025-12-16_102257.png)

- Back on the Server Manager screen, click tasks in the top right corner, then click new share in the dropdown menu

![Screenshot 2025-12-16 102710.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/Screenshot_2025-12-16_102710.png)

- Select SMB Share quick, then Next >

![Screenshot 2025-12-16 103037.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/Screenshot_2025-12-16_103037.png)

- Select the type a custom path for your share location

![Screenshot 2025-12-16 103231.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/Screenshot_2025-12-16_103231.png)

- Select the hackme folder that was made on the C: drive, then click Next>

![Screenshot 2025-12-16 103411.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/Screenshot_2025-12-16_103411.png)
...
![Screenshot 2025-12-16 103625.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/Screenshot_2025-12-16_103625.png)

- After clicking Next> click the box to enable access based enumeration

![Screenshot 2025-12-16 104116.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/Screenshot_2025-12-16_104116.png)

- In the Permissions section you can see that Users and Administrators have both read and write permissions

![Screenshot 2025-12-16 104339.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/Screenshot_2025-12-16_104339.png)

- Now click create

![Screenshot 2025-12-16 104515.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/Screenshot_2025-12-16_104515.png)

- Share was successfully created

![Screenshot 2025-12-16 104640.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/Screenshot_2025-12-16_104640.png)
...
- Head to this PC in the file explorer and select to map a network drive (The drive was already mapped from the previous time I ran the project)
    ...
    ![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image.png)
    
- Enter a drive and enter the name of the server and the folder for the share and click finish

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/images/image%201.png)

- Now we have access to the JAWUNSERVER hackme share

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%202.png)
...
![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%203.png)
...
![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%204.png)
...
![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%205.png)

- The folder is empty but the responder captures this instance

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%206.png)

- The response by the Responder on the Linux VM

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%207.png)

- Open a new tab in the Linux VM terminal and get your IP address

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%208.png)

- Place the IP address in the path name box

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%209.png)

- You are not going to be able to get into it but

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2010.png)
...
![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2011.png)

- Responder stores the hashes in /usr/share/responder/logs

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2012.png)

- Now copy the entire hash including the user and domain

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2013.png)

- Navigate to the root folder and create a file to post the hash in, Nano is used here

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2014.png)
...
![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2015.png)
...
- Type in the terminal
    ...
    ![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2016.png)
    
- It didnt work, so we found another alternative

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2017.png)
...
![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2018.png)

- Head to hashcat’s official website and download the binaires which will include a .7z file

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2019.png)

- Extract the file, my have to use 7zip

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2020.png)

- Go back to Kali and get the hash from the responder logs to copy it in the notepad on Windows

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2021.png)

- type notepad in the Commad Prompt to open the Notepad app. Paste the hash in there and save the file as Hashes.txt

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2022.png)
...
![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2023.png)

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2024.png)

- View the file using the type command in Windows

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2025.png)
...
![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2026.png)

- After deleting the extra hashes, I click save to save the the file under the same name and in the dame location

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2027.png)
...
![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2028.png)

- Now go back to the commnd prompt and run as administrator

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2029.png)

- Navigate back to the created user

![image.png](https://raw.githubusercontent.com/boydjawun/AD-Lab-LLMNR-NTB-NS-Poisoning/main/image%2030.png)
